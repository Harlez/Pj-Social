        ...
        <View style={styles.landing}>
            <ScrollView style={styles.body}>
                ...
                <View style={styles.matricula}>
                    <Text style={styles.titleMatricula}> Venha fazer sua Matrícula </Text>
                    <Text style={styles.textMatricula}>Nossas matrículas são feitas entrem novembro e janeiro,
                    venha fazer sua matrícula ou a do seu filho nesse período! Temos os cursos de:
                    Redes de Computadores, Administração e Enfermagem</Text>

                    <RectButton onPress={Link} style={styles.button}>
                        <Text style={styles.textButton}> Venha até nós </Text>
                    </RectButton>
                </View>
                ...
                <View style={styles.rodape}>
                    <Text>&copy; RedesTechMjm</Text>
                </View>

                <View style={styles.Icon}>
                    <Icons name="instagram" size={20} color={'#004d00'}></Icons>
                    <Icons name="youtube-play" size={20} color={'#004d00'}></Icons>
                    <Icons name="twitter" size={20} color={'#004d00'}></Icons>
                </View>
